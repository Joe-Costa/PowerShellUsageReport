...
The format of the token file is a single line with:

`session-v1:foo..bar..baz..boop..dee..doo..==`

or 

`bearer-v1:foo..bar..baz..boop..dee..doo..==`
...
## Helpful Qumulo Care Articles for RBAC use:
